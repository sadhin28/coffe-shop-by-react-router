            ...
            <div className="container grid gap-6 py-6 md:gap-12 md:py-12">
                ...
                <div className=" grid gap-5 mt-5 ">
                    <div className="collapse collapse-plus text-2xl md:hidden ">
                        ...
                        <div className="collapse-title text-purple-600  font-semibold">Product</div>
                    ...
                    <div className="collapse collapse-plus md:hidden text-2xl ">
                        ...
                        <div className="collapse-title text-purple-600  font-semibold">Company</div>
                    ...
                    <div className="collapse collapse-plus md:hidden text-2xl ">
                        <input type="radio" name="my-accordion-3"  />
                        <div className="collapse-title text-purple-600  font-semibold">Contact</div>
                        <div className="collapse-content text-sm">
                            <ul className="grid gap-5 text-2xl">
                                {Contact}
                            </ul>
